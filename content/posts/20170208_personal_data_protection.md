...
description = "Возникла идея, что защита персональных данных может  \"приблизить восстание машин\". Цепочка следующая - для обеспечения закона вынуждены \"портить\" персональные данные (псевдоидентификаторы, ограничение доступа, практически полная невозможность полной сверки данных) + обычная анонимность в сетях + ..."
