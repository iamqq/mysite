...
description = "Запускается проект по отслеживанию местоположения документов, находящихся на согласовании.Чтобы в любой момент знать где находится документ и сколько он там..."
